...
const BgFormAnt = () => {
  ...
  return (
    <>
      <Spin spinning={isLoading} size="large" tip="Your data has been submited">
        <div className="flex items-center justify-center" from={form}>
          ...
          >
            ...
            <p className="text-red-500">
              এই ফর্মের কাজ চলমান। দয়াকরে গুগল ফর্ম পূরন করুন
            </p>
            ...
            >
              <Space>
                <Radio.Group className="flex flex-col gap-2">
                  <Radio value="A+"> A+ (ve)</Radio>
                  <Radio value="A-"> A- (ve) </Radio>
                  <Radio value="B+"> B+ (ve)</Radio>
                  <Radio value="B-"> B- (ve)</Radio>
                  <Radio value="AB+"> AB+ (ve)</Radio>
                  <Radio value="AB-"> AB- (ve)</Radio>
                  <Radio value="o+"> o+ (ve)</Radio>
                  <Radio value="o-"> o- (ve)</Radio>
                </Radio.Group>
              </Space>
            </Form.Item>
            ...
            >
                ...
                <Select className="capitalize" placeholder="select Your group">
                  <Select.Option value=" A+">A+(ve)</Select.Option>
                  <Select.Option value="A-">A-(ve)</Select.Option>
                  <Select.Option value="B+">B+(ve)</Select.Option>
                  <Select.Option value="B-">B-(ve)</Select.Option>
                  <Select.Option value="o+">o+(ve)</Select.Option>
                  <Select.Option value="o-">o-(ve)</Select.Option>
                  <Select.Option value="AB+">AB+(ve)</Select.Option>
                  <Select.Option value="AB-">AB-(ve)</Select.Option>
                </Select>
