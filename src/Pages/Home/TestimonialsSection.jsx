    ...
    <ScrollRevealSection className="bg-muted/30 py-16 md:py-24">
      <div className="mx-auto max-w-6xl px-4">
        <div className="mb-12 text-center">
          <h2 className="mb-4 text-3xl font-bold md:text-4xl">Success Stories & Testimonials</h2>
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              className="stagger-item border-0 bg-white shadow-sm transition-smooth hover:shadow-lg"
            >
        ...
        <div className="mt-12 text-center">
          <p className="mb-4 text-lg text-muted-foreground">
            These are just a few of the many lives we&apos;ve been privileged to impact
          </p>
          <a
            href="/archives"
            className="inline-block rounded-lg bg-primary px-6 py-3 font-semibold text-white transition-smooth hover:bg-primary/90"
          >
            Read More Stories
          </a>
        </div>
